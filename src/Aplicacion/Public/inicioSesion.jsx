...
import "../../Components/Public/css/inicioSesion.css";
  ...
  const manejarLogin = async (e) => {
    ...
    try {
      const res = await axios.post(
        "https://backend-5gwv.onrender.com/api/entrenador/login",
        {
          Email: correo,
      ...
      localStorage.setItem("entrenador", JSON.stringify(res.data.entrenador));
      console.log("Login exitoso:", res.data.entrenador);
      setUser({acceso:"concedido"});
      navegar("/dashEntrenador");
    } catch (err) {
